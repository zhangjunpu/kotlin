...
class StandaloneDeclarationGenerator(private val context: GeneratorContext) {
    ...
    private val declarationFactory = context.declarationFactory
    ...
    fun generateClass(startOffset: Int, endOffset: Int, origin: IrDeclarationOrigin, descriptor: ClassDescriptor, symbol: IrClassSymbol): IrClass {
        val irClass = declarationFactory.createIrClassFromDescriptor(startOffset, endOffset, origin, symbol, descriptor)
    ...
    fun generateEnumEntry(
        ...
        val irEntry = declarationFactory.createEnumEntry(startOffset, endOffset, origin, symbol, descriptor.name)
    ...
    fun generateProperty(
        ...
        val irProperty = declarationFactory.createProperty(
