...
class JvmInnerClassesSupport(private val declarationFactory: IrDeclarationFactory) : InnerClassesSupport {
    ...
    private fun createInnerClassConstructorWithOuterThisParameter(oldConstructor: IrConstructor): IrConstructor =
        declarationFactory.buildConstructor(oldConstructor.descriptor) {
