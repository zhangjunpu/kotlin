...
open class KotlinBrowserJs @Inject constructor(target: KotlinJsTarget) :
    ...
    private fun configureBuild(
        ...
        registerExecutableTask<Task>(
            disambiguateCamelCased(DISTRIBUTION_TASK_NAME)
        ) {
        ...
        compilation.binaries
            .all { binary ->
                ...
                val webpackTask = registerExecutableTask<KotlinWebpack>(
                    disambiguateCamelCased(
                        binary.executeTaskBaseName,
                        WEBPACK_TASK_NAME
                    ...
                    task.configureOptimization(type)
