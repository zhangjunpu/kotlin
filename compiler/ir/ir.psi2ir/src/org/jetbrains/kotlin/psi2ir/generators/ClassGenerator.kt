...
class ClassGenerator(
    ...
    fun generateClass(ktClassOrObject: KtPureClassOrObject, visibility_: Visibility? = null): IrClass {
        ...
        return context.symbolTable.declareClass(classDescriptor) {
            context.declarationFactory.createIrClassFromDescriptor(
    ...
    private fun generateDelegateFunctionBody(
        ...
        val irBlockBody = context.declarationFactory.createBlockBody(startOffset, endOffset)
        ...
        return context.symbolTable.declareEnumEntry(
            ...
            if (!enumEntryDescriptor.isExpect) {
                irEnumEntry.initializerExpression =
                    context.declarationFactory.createExpressionBody(createBodyGenerator(irEnumEntry.symbol)
