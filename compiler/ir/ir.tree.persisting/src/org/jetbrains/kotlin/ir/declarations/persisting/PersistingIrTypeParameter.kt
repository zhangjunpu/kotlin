...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.TypeParameterCarrier
...
class PersistingIrTypeParameter(
    startOffset: Int,
    endOffset: Int,
    ...
    PersistingIrDeclarationBase<TypeParameterCarrier>(startOffset, endOffset, origin),
    IrTypeParameter,
