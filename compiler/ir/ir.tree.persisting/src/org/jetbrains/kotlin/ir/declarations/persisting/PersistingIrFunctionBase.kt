...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.FunctionBaseCarrier
...
abstract class PersistingIrFunctionBase<T : FunctionBaseCarrier>(
    startOffset: Int,
    endOffset: Int,
    ...
    PersistingIrDeclarationBase<T>(startOffset, endOffset, origin),
    IrFunction,
    FunctionBaseCarrier {
