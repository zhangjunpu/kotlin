...
@PublishedApi
internal fun IrDeclarationFactory.buildClass(builder: IrClassBuilder): IrClass = with(builder) {
...
inline fun IrDeclarationFactory.buildClass(builder: IrClassBuilder.() -> Unit) =
    IrClassBuilder().run {
        builder()
        buildClass(this)
    }
...
@PublishedApi
internal fun IrDeclarationFactory.buildField(builder: IrFieldBuilder): IrField = with(builder) {
...
inline fun IrDeclarationFactory.buildField(builder: IrFieldBuilder.() -> Unit) =
    IrFieldBuilder().run {
        builder()
        buildField(this)
    }
...
@PublishedApi
internal fun IrDeclarationFactory.buildProperty(
...
inline fun IrDeclarationFactory.buildProperty(originalDescriptor: PropertyDescriptor? = null, builder: IrPropertyBuilder.() -> Unit) =
...
@PublishedApi
internal fun IrDeclarationFactory.buildFunction(
...
@PublishedApi
internal fun IrDeclarationFactory.buildConstructor(
...
inline fun IrDeclarationFactory.buildFun(
...
inline fun IrDeclarationFactory.addFunction(klass: IrDeclarationContainer, builder: IrFunctionBuilder.() -> Unit): IrSimpleFunction =
...
inline fun IrDeclarationFactory.buildConstructor(
...
@PublishedApi
internal fun IrDeclarationFactory.buildValueParameter(builder: IrValueParameterBuilder, parent: IrDeclarationParent): IrValueParameter =
    with(builder) {
...
@PublishedApi
internal fun IrDeclarationFactory.buildTypeParameter(builder: IrTypeParameterBuilder, parent: IrDeclarationParent): IrTypeParameter =
    with(builder) {
