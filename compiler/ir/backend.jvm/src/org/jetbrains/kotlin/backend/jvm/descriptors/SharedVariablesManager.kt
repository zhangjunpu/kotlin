...
class JvmSharedVariablesManager(
    ...
    private val refNamespaceClass = declarationFactory.addClass(jvmInternalPackage) {
    ...
    private val primitiveRefProviders = irBuiltIns.primitiveIrTypes.associate { primitiveType ->
        val refClass = declarationFactory.addClass(refNamespaceClass) {
            origin = IrDeclarationOrigin.IR_BUILTINS_STUB
...
private inline fun IrDeclarationFactory.addClass(
