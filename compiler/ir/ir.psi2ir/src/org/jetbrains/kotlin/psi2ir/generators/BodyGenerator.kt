...
class BodyGenerator(
    ...
    fun generateFunctionBody(ktBody: KtExpression): IrBody {
        ...
        val irBlockBody = context.declarationFactory.createBlockBody(ktBody.startOffsetSkippingComments, ktBody.endOffset)
    ...
    fun generateExpressionBody(ktExpression: KtExpression): IrExpressionBody =
        context.declarationFactory.createExpressionBody(createStatementGenerator().generateExpression(ktExpression))
    ...
    fun generateSecondaryConstructorBody(ktConstructor: KtSecondaryConstructor): IrBody {
        val irBlockBody = context.declarationFactory.createBlockBody(ktConstructor.startOffsetSkippingComments, ktConstructor.endOffset)
    ...
    fun generatePrimaryConstructorBody(ktClassOrObject: KtPureClassOrObject): IrBody {
        val irBlockBody = context.declarationFactory.createBlockBody(ktClassOrObject.pureStartOffset, ktClassOrObject.pureEndOffset)
