...
class AndroidSymbols(
    ...
    val androidOsParcelableCreator: IrClassSymbol = declarationFactory.buildClass {
    ...
    val kotlinKClassJava: IrPropertySymbol = declarationFactory.buildProperty {
    ...
    ): IrClassSymbol = declarationFactory.buildClass {
