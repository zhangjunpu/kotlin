        ...
        if (rangeMarker != null) {
            if (rangeMarker.isValid) {
                ShortenReferences.DEFAULT.process(
                    ...
                    filter,
                    actionRunningMode = ActionRunningMode.RUN_IN_EDT_UNDO_TRANSPARENT
                )
            }
        } else {
            ShortenReferences.DEFAULT.process(file, filter, actionRunningMode = ActionRunningMode.RUN_IN_EDT_UNDO_TRANSPARENT)
        }
    }
}
