...
class JvmBackendContext(
    ...
    internal val innerClassesSupport = JvmInnerClassesSupport(declarationFactory)
    ...
    override val sharedVariablesManager = JvmSharedVariablesManager(state.module, ir.symbols, irBuiltIns, declarationFactory)
    ...
    val inlineClassReplacements = MemoizedInlineClassReplacements(state.functionsWithInlineClassReturnTypesMangled, declarationFactory)
