...
import org.jetbrains.kotlin.ir.expressions.persisting.PersistingIrBlockBody
import org.jetbrains.kotlin.ir.expressions.persisting.PersistingIrExpressionBody
import org.jetbrains.kotlin.ir.symbols.*
import org.jetbrains.kotlin.ir.types.IrType
import org.jetbrains.kotlin.name.Name
import org.jetbrains.kotlin.types.Variance

object PersistingIrDeclarationFactory : IrDeclarationFactory {
    override fun createAnonymousInitializer(
        ...
        PersistingIrAnonymousInitializer(startOffset, endOffset, origin, symbol, isStatic)
    ...
    override fun createEnumEntry(
        ...
        PersistingIrEnumEntry(startOffset, endOffset, origin, symbol, name)
    ...
    override fun createErrorDeclaration(
        ...
        PersistingIrErrorDeclaration(startOffset, endOffset, descriptor)
    ...
    override fun createField(
        ...
        PersistingIrField(startOffset, endOffset, origin, symbol, name, type, visibility, isFinal, isExternal, isStatic)
    ...
    override fun createFakeOverrideFunction(
        ...
        PersistingIrFakeOverrideFunction(
    ...
    override fun createLocalDelegatedProperty(
        ...
        PersistingIrLocalDelegatedProperty(
    ...
    override fun createFakeOverrideProperty(
        ...
        PersistingIrFakeOverrideProperty(
    ...
    override fun createTypeAlias(
        ...
        PersistingIrTypeAlias(startOffset, endOffset, symbol, name, visibility, expandedType, isActual, origin)
    ...
    override fun createTypeParameter(
        ...
        PersistingIrTypeParameter(startOffset, endOffset, origin, symbol, name, index, isReified, variance)
    ...
    override fun createValueParameter(
        ...
        PersistingIrValueParameter(startOffset, endOffset, origin, symbol, name, index, type, varargElementType, isCrossinline, isNoinline)
    ...
    override fun createExpressionBody(
        ...
        PersistingIrExpressionBody(startOffset, endOffset, initializer)
    ...
    override fun createExpressionBody(
        ...
        PersistingIrExpressionBody(startOffset, endOffset, expression)

    override fun createExpressionBody(
        expression: IrExpression,
    ): IrExpressionBody =
        PersistingIrExpressionBody(expression)

    override fun createBlockBody(
        startOffset: Int,
        endOffset: Int,
    ): IrBlockBody =
        PersistingIrBlockBody(startOffset, endOffset)
    ...
    override fun createBlockBody(
        ...
        PersistingIrBlockBody(startOffset, endOffset, statements)
    ...
    override fun createBlockBody(
        ...
        PersistingIrBlockBody(startOffset, endOffset, initializer)
}
