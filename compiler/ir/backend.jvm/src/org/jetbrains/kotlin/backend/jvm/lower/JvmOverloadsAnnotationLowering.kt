...
private class JvmOverloadsAnnotationLowering(val context: JvmBackendContext) : ClassLoweringPass {
    ...
    private fun generateWrapper(target: IrFunction, numDefaultParametersToExpect: Int): IrFunction {
        val wrapperIrFunction = context.declarationFactory.generateWrapperHeader(target, numDefaultParametersToExpect)
    ...
    private fun IrDeclarationFactory.generateWrapperHeader(oldFunction: IrFunction, numDefaultParametersToExpect: Int): IrFunction {
