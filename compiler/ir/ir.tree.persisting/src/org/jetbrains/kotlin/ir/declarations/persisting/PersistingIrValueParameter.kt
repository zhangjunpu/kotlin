...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.ValueParameterCarrier
...
class PersistingIrValueParameter(
    startOffset: Int,
    endOffset: Int,
    ...
    PersistingIrDeclarationBase<ValueParameterCarrier>(startOffset, endOffset, origin),
    IrValueParameter,
