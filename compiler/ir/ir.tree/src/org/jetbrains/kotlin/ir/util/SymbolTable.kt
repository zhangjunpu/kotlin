...
class SymbolTable(
    ...
    fun declareAnonymousInitializer(
        ...
        declarationFactory.createAnonymousInitializer(
    ...
    fun declareEnumEntry(
        ...
        factory: (IrEnumEntrySymbol) -> IrEnumEntry = {
            declarationFactory.createEnumEntry(startOffset, endOffset, origin, it, nameProvider.nameForDeclaration(descriptor))
        }
    ): IrEnumEntry =
