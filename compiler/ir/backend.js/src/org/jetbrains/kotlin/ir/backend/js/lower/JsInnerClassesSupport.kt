...
class JsInnerClassesSupport(mapping: JsMapping, private val declarationFactory: IrDeclarationFactory) : InnerClassesSupport {
    ...
    private fun createInnerClassConstructorWithOuterThisParameter(oldConstructor: IrConstructor): IrConstructor {
        ...
        val newConstructor = declarationFactory.buildConstructor(oldConstructor.descriptor) {
