...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.PropertyCarrier
...
abstract class PersistingIrPropertyCommon(
    startOffset: Int,
    endOffset: Int,
...
) : PersistingIrDeclarationBase<PropertyCarrier>(startOffset, endOffset, origin),
    IrProperty,
    PropertyCarrier {
...
class PersistingIrProperty(
    ...
    override val isFakeOverride: Boolean = origin == IrDeclarationOrigin.FAKE_OVERRIDE
) : PersistingIrPropertyCommon(
    startOffset, endOffset, origin, name, visibility, modality, isVar, isConst, isLateinit, isDelegated, isExternal, isExpect,
    isFakeOverride
) {
    init {
        symbol.bind(this)
...
class PersistingIrFakeOverrideProperty(
    startOffset: Int,
    endOffset: Int,
    origin: IrDeclarationOrigin,
    name: Name,
