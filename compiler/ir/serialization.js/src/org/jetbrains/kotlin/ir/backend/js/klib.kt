...
fun generateKLib(
    ...
    val psi2IrContext = runAnalysisAndPreparePsi2Ir(depsDescriptors, declarationFactory)
...
fun loadIr(
    ...
    when (mainModule) {
        is MainModule.SourceFiles -> {
            val psi2IrContext: GeneratorContext = runAnalysisAndPreparePsi2Ir(depsDescriptors, declarationFactory)
            val irBuiltIns = psi2IrContext.irBuiltIns
        ...
        is MainModule.Klib -> {
            ...
            val symbolTable = SymbolTable(signaturer, declarationFactory)
...
private fun runAnalysisAndPreparePsi2Ir(depsDescriptors: ModulesStructure, declarationFactory: IrDeclarationFactory): GeneratorContext {
    ...
    val symbolTable = SymbolTable(IdSignatureDescriptor(JsManglerDesc), declarationFactory)
