...
import org.jetbrains.kotlin.ir.declarations.persisting.carriers.ClassCarrier
...
class PersistingIrClass(
    ...
    PersistingIrDeclarationBase<ClassCarrier>(startOffset, endOffset, origin),
    IrClass,
    ClassCarrier {
