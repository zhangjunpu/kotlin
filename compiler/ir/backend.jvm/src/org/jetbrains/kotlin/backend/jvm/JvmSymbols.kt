...
class JvmSymbols(
    ...
    private val intrinsicsClass: IrClassSymbol = createClass(
        ...
        klass.declarations.add(declarationFactory.buildClass {
        ...
        return propertyReferenceClassCache.getOrPut(key) {
            ...
            createClass(
                ...
                klass.addProperty {
                    ...
                    backingField = declarationFactory.buildField {
                        name = receiverFieldName
    ...
    val kClassJava: IrPropertySymbol =
        declarationFactory.buildProperty {
