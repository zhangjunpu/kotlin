...
import org.jetbrains.kotlin.gradle.model.builder.KotlinParcelizeModelBuilder
import org.jetbrains.kotlin.gradle.plugin.*
import org.jetbrains.kotlin.gradle.plugin.mpp.KotlinJvmAndroidCompilation
import javax.inject.Inject

// Use apply plugin: 'kotlin-parcelize' to enable Android Extensions in an Android project.
class ParcelizeSubpluginIndicator @Inject internal constructor(private val registry: ToolingModelBuilderRegistry) :
    Plugin<Project> {
    override fun apply(project: Project) {
        addParcelizeRuntime(project)
        registry.register(KotlinParcelizeModelBuilder())
        project.plugins.apply(ParcelizeSubplugin::class.java)
    }
...
class ParcelizeSubplugin : KotlinCompilerPluginSupportPlugin {
    override fun isApplicable(kotlinCompilation: KotlinCompilation<*>): Boolean {
        ...
        if (project.plugins.findPlugin(ParcelizeSubpluginIndicator::class.java) == null) {
            return false
        }
